...
import 'package:wavemall/model/CityList.dart';
import 'package:wavemall/model/CountryList.dart';
import 'package:wavemall/model/GeneralSettingsModel.dart';
import 'package:wavemall/model/StateList.dart';
                                      ...
                                      child: _addressController
                                          ...
                                          : DropdownButton<AllCity>(
                                              ...
                                              style: Theme.of(context)
                                                  ...
                                                  .copyWith(fontSize: 15.0),
                                              onChanged: (value) {
                                                _addressController.selectedCity
                                                    .value = value!;
                                              },
                                              value: _addressController
                                                  .selectedCity.value,
