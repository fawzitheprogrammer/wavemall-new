...
import 'package:wavemall/model/GeneralSettingsModel.dart';
...
import 'package:wavemall/view/cart/GatewaySelection.dart';
import 'package:wavemall/view/settings/AddAddress.dart';
    ...
    checkoutController.checkoutModel.value.packages!.forEach((key, value) {
      value.items!.forEach((CheckoutItem itemEl) {
        if (itemEl.productType == ProductType.PRODUCT) {
          additionalShipping +=
              (itemEl.product?.sku?.additionalShipping == null)
                  ? 0.0
