...
import 'package:wavemall/model/SellerFilterModel.dart';
import 'package:wavemall/utils/styles.dart';
import 'package:wavemall/view/seller/SellerProductsLoadMore.dart';
  ...
  void initState() {
    ...
    if (controller!.seller.value.lowestPrice != null &&
      ...
      _currentRangeValues = RangeValues(
          ...
          int.parse(controller!.seller.value.heightPrice.toString())
              .toDouble());
    }
    super.initState();
  }
    ...
    controller!.sellerFilter.value.filterType!.forEach((element) {
      if (element.filterTypeId == 'price_range') {
        ...
        element.filterTypeValue!.addAll([
          [controller!.lowRangeCatCtrl.text, controller!.highRangeCatCtrl.text]
        ]);
      }
    });
    controller!.sellerFilter.value.filterType!.forEach((element) {
