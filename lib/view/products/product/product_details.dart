...
import 'package:wavemall/controller/my_wishlist_controller.dart';
import 'package:wavemall/controller/product_details_controller.dart';
...
import 'package:wavemall/model/Product/ProductVariantDetail.dart';
...
import 'package:wavemall/view/products/RatingsAndReviews.dart';
import 'package:wavemall/view/products/category/ProductsByCategory.dart';
import 'package:wavemall/view/products/tags/ProductsByTags.dart';
import 'package:wavemall/view/seller/StoreHome.dart';
import 'package:wavemall/widgets/CustomDate.dart';
import 'package:wavemall/widgets/SliverAppBarTitleWidget.dart';
import 'package:wavemall/widgets/StarCounterWidget.dart';
import 'package:wavemall/widgets/custom_color_convert.dart';
import 'package:wavemall/widgets/custom_loading_widget.dart';
import 'package:wavemall/widgets/custom_radio_button.dart';
import 'package:wavemall/widgets/single_product_widgets/HorizontalProductWidget.dart';
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        Share.share(
                                            '${URLs.HOST}/product/${_productDetailsModel.data!.slug}',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  _productDetailsModel.data!.reviews!.length <=
                                          0
                                      ? Text(
                          ...
                          child: Container(
                            ...
                            child: badges.Badge(
                              ...
                              showBadge: _loginController.loggedIn.value
                                  ...
                                  : false,
                              position:
                                  badges.BadgePosition.topEnd(end: 4, top: 0),
                              badgeAnimation:
                                  badges.BadgeAnimation.size(toAnimate: false),
