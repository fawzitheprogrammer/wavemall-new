...
import 'package:wavemall/model/Category/CategoryMain.dart';
import 'package:wavemall/model/Category/ParentCategory.dart';
import 'package:wavemall/model/Category/SingleCategory.dart';
  ...
  void didChangeDependencies() {
    ...
    categoryFuture!.then((value) {
      setState(() {
        ...
        subCategoryFuture = getSubCategory(value.data!.data!
            .where((element) => element.parentId == 0)
            .first
            .id);
