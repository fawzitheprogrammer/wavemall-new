...
import 'package:wavemall/model/FilterFromCatModel.dart';
import 'package:wavemall/model/Brand/SingleBrandModel.dart';
import 'package:wavemall/model/Product/AllProducts.dart';
import 'package:wavemall/model/Product/ProductModel.dart';
import 'package:wavemall/model/SortingModel.dart';
...
import 'package:wavemall/widgets/single_product_widgets/ListViewProductWidget.dart';
                ...
                SliverPadding(
                  ...
                  sliver: Obx(() {
                    if (_brandController!.isBrandsProductsLoading.value) {
                      ...
                      if (_brandController!.brandAllData.value.data!
