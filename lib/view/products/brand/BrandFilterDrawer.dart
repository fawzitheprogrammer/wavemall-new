...
import 'package:wavemall/model/Filter/FilterAttributeValue.dart';
import 'package:wavemall/model/Filter/FilterColor.dart';
import 'package:wavemall/utils/styles.dart';
import 'package:wavemall/view/products/brand/ProductsByBrands.dart';
import 'package:wavemall/view/products/brand/brand_controller.dart';
import 'package:wavemall/widgets/PinkButtonWidget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:flutter_xlider/flutter_xlider.dart';
import 'package:get/get.dart';
import 'package:wavemall/widgets/BlueButtonWidget.dart';
          ...
          children: [
                    ...
                    builder: (context) {
                      ...
                      return MultiSelectChipField<CategoryData>(
                        ...
                        itemBuilder: (item, state) {
                          return Card(
                            color: controller!.selectedBrandCat
                                    .contains(item.value)
                                ? AppStyles.darkBlueColor
                                : Colors.white,
                            elevation: controller!.selectedBrandCat
                                    .contains(item.value)
                                ? 5
                                : 3,
            ...
            controller!.brandAllData.value.attributes!.length > 0
                ? ListView.builder(
                    ...
                    itemCount:
                        controller!.brandAllData.value.attributes!.length,
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          controller!.brandAllData.value.attributes![attIndex]
                              ...
                              ? Builder(
                                  builder: (context) {
                                    final _items = controller!.brandAllData
                                        .value.attributes![attIndex].values!
            ...
            showRange
                ? Padding(
                    ...
                    child: FlutterSlider(
                      ...
                      min:
                          controller!.brandAllData.value.lowestPrice.toDouble(),
                      max:
                          controller!.brandAllData.value.heightPrice.toDouble(),
                      onDragCompleted:
