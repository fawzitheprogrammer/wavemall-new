...
import 'package:wavemall/view/account/AccountPage.dart';
...
import 'package:wavemall/widgets/custom_clipper.dart';
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: Container(
                  child: Stack(
                    ...
                    children: [
                      Positioned.fill(
                        child: widget.giftcard!.giftCardGalleryImages!.length >
                                1
                            ? Container(
                                child: Swiper(
                                  itemBuilder:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              settingsController.calculateGiftcardPrice(
                                      widget.giftcard!) +
            ...
            builder: (BuildContext context, int index) {
              return PhotoViewGalleryPageOptions(
                imageProvider: NetworkImage(AppConfig.assetPath +
                    '/' +
                    widget.giftCard!.giftCardGalleryImages![index]
                        .giftCardImage!),
