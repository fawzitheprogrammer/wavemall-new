...
class SupportTicketModel {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "statuses": List<dynamic>.from(statuses!.isEmpty ? [] : statuses!.map((x) => x.toJson())),
        "msg": msg,
      };
}
...
class Tickets {
  ...
  Map<String, dynamic> toJson() => {
        "data": List<dynamic>.from(data!.isEmpty ? [] : data!.map((x) => x.toJson())),
        "total": total,
      };
}
...
class TicketData {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "created_at": createdAt == null ? DateTime.now() : createdAt!.toIso8601String(),
        "updated_at": updatedAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "messages": List<dynamic>.from(messages!.isEmpty ? [] : messages!.map((x) => x.toJson())),
      };
}
...
class Message {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "updated_at": updatedAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "attach_msg_file":
            List<dynamic>.from(attachMsgFile!.isEmpty ? [] : attachMsgFile!.map((x) => x.toJson())),
...
class TicketCategories {
  ...
  Map<String, dynamic> toJson() => {
        "categories": List<dynamic>.from(categories!.isEmpty ? [] : categories!.map((x) => x.toJson())),
        "msg": msg,
      };
}
...
class TicketPriorities {
  ...
  Map<String, dynamic> toJson() => {
        "priorities": List<dynamic>.from(priorities!.isEmpty ? [] : priorities!.map((x) => x.toJson())),
        "msg": msg,
      };
}
