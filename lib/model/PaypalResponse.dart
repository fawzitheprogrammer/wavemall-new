...
class PaypalResponse {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "transactions": List<dynamic>.from(transactions!.isEmpty? []: transactions!.map((x) => x.toJson())),
        "failed_transactions":
            List<dynamic>.from(failedTransactions!.isEmpty? [] : failedTransactions!.map((x) => x)),
        "create_time": createTime == null ? DateTime.now() : createTime!.toIso8601String(),
        "update_time": updateTime == null ? DateTime.now() : updateTime!.toIso8601String(),
        "links": List<dynamic>.from(links!.isEmpty? [] : links!.map((x) => x.toJson())),
      };
}
...
class Payer {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "status": status,
        "payer_info": payerInfo == null ? null : payerInfo!.toJson(),
      };
}
...
class Transaction {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "payee": payee == null ? null : payee!.toJson(),
        "description": description,
        "item_list": itemList == null ? null : itemList!.toJson(),
        "related_resources":
            List<dynamic>.from(relatedResources!.isEmpty ? [] : relatedResources!.map((x) => x.toJson())),
      };
}
...
class ItemList {
  ...
  Map<String, dynamic> toJson() => {
        "items": List<dynamic>.from(items!.isEmpty? [] : items!.map((x) => x.toJson())),
        "shipping_address": shippingAddress == null? null : shippingAddress!.toJson(),
