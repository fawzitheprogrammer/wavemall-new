...
class FilterFromCatModel {
  ...
  Map<String, dynamic> toJson() => {
        "filterDataFromCat": filterDataFromCat== null? null: filterDataFromCat!.toJson(),
        "sort_by": sortBy,
...
class FilterDataFromCat {
  ...
  Map<String, dynamic> toJson() => {
        "requestItemType": requestItemType,
        "requestItem": requestItem,
        "filterType": List<dynamic>.from(filterType!.isEmpty? []: filterType!.map((x) => x.toJson())),
      };
}
...
class FilterType {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "filterTypeValue": List<dynamic>.from(filterTypeValue!.isEmpty? []: filterTypeValue!.map((x) => x)),
      };
}
