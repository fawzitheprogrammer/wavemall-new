...
import 'package:wavemall/model/Product/CrossSaleProduct.dart';
import 'package:wavemall/model/Product/GstGroup.dart';
import 'package:wavemall/model/Product/RelatedProduct.dart';
import 'package:wavemall/model/Product/UpSalesProduct.dart';
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        gstGroup: json["gst_group"] == null
            ? null
            : GstGroup.fromJson(json["gst_group"]),
        skus: json["skus"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
        ...
        "categories": categories == null
            ? null
            : List<dynamic>.from(
                categories!.isEmpty ? [] : categories!.map((x) => x.toJson())),
        "tags": tags == null
            ? null
            : List<dynamic>.from(
                tags!.isEmpty ? [] : tags!.map((x) => x.toJson())),
        "gallary_images": gallaryImages == null
            ? null
            : List<dynamic>.from(gallaryImages!.isEmpty
                ? []
                : gallaryImages!.map((x) => x.toJson())),
        "related_products": relatedProducts == null
            ? null
            : List<dynamic>.from(relatedProducts!.isEmpty
                ? []
                : relatedProducts!.map((x) => x.toJson())),
      };
}
