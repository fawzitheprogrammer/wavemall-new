...
class GeneralSettingsModel {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "currencies": List<dynamic>.from(
            currencies!.isEmpty ? [] : currencies!.map((x) => x.toJson())),
        "vendorType": vendorType,
        "pickup_locations": List<dynamic>.from(pickupLocations!.isEmpty
            ? []
            : pickupLocations!.map((x) => x.toJson())),
        ...
        "otp_configuration": otpConfiguration == null
            ? null
            : List<dynamic>.from(otpConfiguration!.isEmpty
                ? []
                : otpConfiguration!.map((x) => x.toJson())),
        "modules":
