...
class WaitingReviewModel {
  ...
  Map<String, dynamic> toJson() => {
        "packages": List<Package>.from(
            packages!.isEmpty ? [] : packages!.map((x) => x.toJson())),
        "message": message,
      };
}
...
class Package {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "updated_at":
            createdAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "deliveryStateName": deliveryStateName,
        "totalGST": totalGst,
        "order": order == null ? null : order!.toJson(),
        "products": List<dynamic>.from(
            products!.isEmpty ? [] : products!.map((x) => x.toJson())),
        "gst_taxes": List<dynamic>.from(
            gstTaxes!.isEmpty ? [] : gstTaxes!.map((x) => x.toJson())),
      };
}
...
class ProductElement {
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "package_id": packageId,
        "type": typeValues.reverse!.isEmpty ? [] : typeValues.reverse![type],
        ...
        "updated_at":
            updatedAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "seller_product_sku":
            sellerProductSku == null ? null : sellerProductSku!.toJson(),
...
class SellerProductSkuProduct {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "avg_rating": avgRating,
        "recent_view":
            recentView == null ? DateTime.now() : recentView!.toIso8601String(),
        "created_at":
            createdAt == null ? DateTime.now() : createdAt!.toIso8601String(),
        "updated_at":
            updatedAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "variantDetails": List<dynamic>.from(variantDetails!.isEmpty
            ? []
            : variantDetails!.map((x) => x.toJson())),
        "MaxSellingPrice": maxSellingPrice,
        "hasDeal": hasDeal,
        "rating": rating,
        "product": product == null ? null : product!.toJson(),
        "skus": List<dynamic>.from(
            skus!.isEmpty ? [] : skus!.map((x) => x.toJson())),
        "reviews": List<dynamic>.from(
            reviews!.isEmpty ? [] : reviews!.map((x) => x.toJson())),
      };
}
...
class SellerProductSku {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "updated_at":
            updatedAt == null ? DateTime.now() : updatedAt!.toIso8601String(),
        "product": product == null ? null : product!.toJson(),
        "product_variations": List<dynamic>.from(productVariations!.isEmpty
            ? []
            : productVariations!.map((x) => x.toJson())),
      };
}
...
class VariantDetail {
  ...
  Map<String, dynamic> toJson() => {
        "value": List<dynamic>.from(value!.isEmpty ? [] : value!.map((x) => x)),
        "code": List<dynamic>.from(code!.isEmpty ? [] : code!.map((x) => x)),
        "attr_val_id": List<dynamic>.from(
            attrValId!.isEmpty ? [] : attrValId!.map((x) => x)),
        "name": nameValues == null ? null : nameValues.reverse![name],
        "attr_id": attrId,
      };
}
...
class ProductVariation {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "updated_at": updatedAt == null ? null : updatedAt!.toIso8601String(),
        "attribute_value":
            attributeValue == null ? null : attributeValue!.toJson(),
...
class Attribute {
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "name": name,
        "display_type": displayTypeValues == null
            ? null
            : displayTypeValues.reverse![displayType],
